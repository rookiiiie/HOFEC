...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str,
                        ...
                        ,default='E:/localPy/HOFEC/host_folder/ho3d')
    parser.add_argument('--pred_file_name', type=str, default='pred_{}.json',
                        help='Name of the eval file.')
    parser.add_argument('--output_dir', type=str,
                        help='Path to where the eval result should be.'
                        ,default='E:/localPy/HOFEC/host_folder/ho3d/evalResult')
