def add_opts(parser):
    ...
    # options for model
    parser.add_argument("--network", default="hofec_transformer",
                        choices=["hofec_attention", "hofec_transformer"], help="network architecture")
    ...
    # options for loss
    parser.add_argument("--mano_neurons", nargs="+", 
    default=[1024, 512],
    # default=[256, 128],
    # default = [768, 384],
    type=int,
    ...
    parser.add_argument("--mano_lambda_regulshape", default=0, type=float, # semi:default=1e2
                        help="Weight to regularize hand shapes")
    parser.add_argument("--mano_lambda_regulpose", default=0, type=float, # semi:default=1
    ...
    parser.add_argument("--transformer_head", default=4, type=int, help="transformer attention head") # semi:default=1--看来这东西可能确实要大点好

    # options for training
    parser.add_argument("--manual_seed", default=0, type=int, help="manual seed") # 114514?3407?41?
    parser.add_argument("-j", "--workers", default=3, type=int, help="number of data loading workers (default: 16)")
